...
public class UdacityTutorialCombiners {
	...
	public static class UdCombiner extends Reducer<Text,DoubleWritable, Text,DoubleWritable> 
	{
	...
	public static void main(String args[]) throws Exception {
		...
		Job job = Job.getInstance(conf, "UdacityTutorialCombiners");
		
		job.setJarByClass(UdacityTutorialCombiners.class);
		job.setOutputKeyClass(Text.class);
		job.setOutputValueClass(DoubleWritable.class);
		job.setMapperClass(UdMap.class);
		job.setCombinerClass(UdCombiner.class);
